...
public class SimonSays extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		images.put(new Integer(KeyEvent.VK_X), "X.png");
		images.put(new Integer(KeyEvent.VK_T), "T.png");
		images.put(new Integer(KeyEvent.VK_K), "K.jpg");
		//images.put(new Integer(KeyEvent.VK_R), "R.jpg"); /*Doesn't work*/
		//images.put(new Integer(KeyEvent.VK_N), "N.jpg"); /*Doesn't work*/
		// 3. Tell the user to "Press the matching key when 'Simon says' otherwise press a different key"
		JOptionPane.showMessageDialog(null, "Press the matching key if they say 'Simon Says.' Otherwise, hit a different key.");
	...
	public void keyPressed(KeyEvent e) {
		...
		if(keyCode == imageIndex && didSimonSay == true) {
			points++;
			speak("That was correct.");
		}
		if(keyCode != imageIndex && didSimonSay == false) {
			points++;
			speak("That was correct.");
		}
